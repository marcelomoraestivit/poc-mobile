...
│   └── sync/                  # Sync Manager
├── App.Embedded.tsx        # Modo Embedded (Fullscreen)
├── App.tsx                  # Modo Full (com TabBar)
...
# Modo de Operação
npm run mode:full      # Modo completo (com TabBar)
npm run mode:embedded  # Modo embedded (fullscreen)
...
| [EMBEDDED_MODE.md](./docs/EMBEDDED_MODE.md) | Modo Embedded (Fullscreen) |
