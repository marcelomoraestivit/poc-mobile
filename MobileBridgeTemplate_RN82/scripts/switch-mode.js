...
if (!mode || !['full', 'embedded', 'testhost'].includes(mode)) {
  console.error('Usage: node switch-mode.js [full|embedded|testhost]');
  console.error('');
  console.error('Modes:');
  console.error('  full     - Full app with TabBar navigation');
...
if (mode === 'full') {
  ...
  description = 'FULL mode (with TabBar)';
